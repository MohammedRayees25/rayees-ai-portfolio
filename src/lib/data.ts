...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tag: "GenAI · Video",
    description:
      "AI-powered UGC (user-generated content) video generator that turns prompts and product inputs into short-form marketing videos using generative AI, scripted scenes, voiceover, and automated rendering.",
    features: [
    ...
    repo: "https://github.com/MohammedRayees25/ugc-video-generator",
    highlight: "02",
  },
];
